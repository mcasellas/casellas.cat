        ...
        >
          ...
          >
            <Link to={`/photos/tradicions${images[0] ? `?photo=${encodeURIComponent(images[0].filename)}` : ''}`} className="absolute inset-0 block">
              ...
              <div className="absolute bottom-0 left-0 w-full p-3 md:p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h2 className="text-sm md:text-lg font-black tracking-tighter text-white/80 uppercase">
